...
/**
 * If there is no bug, Created by Mcablylx on 2018-10-30.
...
constructor(activity: Activity) {
    ...
    private fun setupStatusBarView(context: Context, decorViewGroup: ViewGroup) {
        ...
        mStatusBarTintView!!.setBackgroundColor(DEFAULT_TINT_COLOR.toInt())
    ...
    private fun setupNavBarView(context: Context, decorViewGroup: ViewGroup) {
        ...
        mNavBarTintView!!.setBackgroundColor(DEFAULT_TINT_COLOR.toInt())
     ...
     *
     */
    class SystemBarConfig constructor(activity: Activity, private val mTranslucentStatusBar: Boolean, private val mTranslucentNavBar: Boolean) {
        /**
    ...
    companion object {
         ...
         */
        val DEFAULT_TINT_COLOR = 0x99000000
